...
class PasswordChangeTests(TestCase):
    ...
    def test_form_inputs(self):
        '''
        The view must contain the following inputs:
          * csrf
          * old_password
          * new_password1
          * new_password2
...
class PasswordChangeTestCase(TestCase):
    '''
    Base test case for form processing -- accepts
    a data dict. to POST to the view
    '''
    def setUp(self, data={}):
...
class SuccessfulPasswordChangeTests(PasswordChangeTestCase):
    ...
    def test_password_changed(self):
        '''
        Refresh the user instance from database to get
        the new password hash updated by the change password
        view.
        '''
    ...
    def test_user_authentication(self):
        ...
        its context after a successful signup.
        '''
