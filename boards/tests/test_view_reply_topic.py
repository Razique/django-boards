...
class ReplyTopicTests(ReplyTopicTestCase):
    ...
    def test_form_inputs(self):
        '''
        The view must contain two inputs: csrf, messagge textarea
        '''
...
class SuccessfulReplyTopicTests(ReplyTopicTestCase):
    ...
    def test_reply_created(self):
        '''
        The total post count should be two:
          * The one created in the ReplyTopicTest Case setUp
          * Another one created by the post data in this class
        '''
        self.assertEquals(Post.objects.count(), 2)


class InvalidReplyTopicsTests(ReplyTopicTestCase):
    def setUp(self):
        '''
